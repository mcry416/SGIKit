...
public func memoVar<T>(_ ref: T){
#if DEBUG
    print("┏━━━━━━━━━━━━━━━━━━━━━┓ ")
    print("┃     𝘔𝘌𝘔𝘖𝘙𝘠  𝙍𝙚𝙛      ┃ ")
    print("┃━━━━━━━━━━━━━━━━━━━━━┃ ")
    print("┃    Variable Type:   ┃\(type(of: ref))")
    print("┃    Variable Addr:   ┃\(Mems.ptr(ofRef: ref))")
    print("┃    Variable Memo:   ┃\(Mems.memStr(ofRef: ref))")
    print("┃    Variable Size:   ┃\(Mems.size(ofRef: ref))")
    print("┗━━━━━━━━━━━━━━━━━━━━━┛")
#endif
}

public func memoInout<T>(_ val: inout T){
#if DEBUG
    print("┏━━━━━━━━━━━━━━━━━━━━━┓ ")
    print("┃     𝘔𝘌𝘔𝘖𝘙𝘠  𝙑𝙖𝙡      ┃ ")
    print("┃━━━━━━━━━━━━━━━━━━━━━┃ ")
    print("┃    Variable Type:   ┃\(type(of: val))")
    print("┃    Variable Addr:   ┃\(Mems.ptr(ofVal: &val))")
    print("┃    Variable Memo:   ┃\(Mems.memStr(ofVal: &val))")
    print("┃    Variable Size:   ┃\(Mems.size(ofVal: &val))")
    print("┗━━━━━━━━━━━━━━━━━━━━━┛")
#endif
}
