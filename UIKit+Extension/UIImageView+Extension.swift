...
extension UIImageView {
    ...
    private static var sgImageCaches: SGImageViewCache = { SGImageViewCache(limitCount: 100) }()
    
    public func sg_setImage(_ urlString: String, placeholderName placeholder: String? = nil) {
...
class SGImageViewCache: NSObject {
    var lru = LinkMap()
    var lock = NSLock()
