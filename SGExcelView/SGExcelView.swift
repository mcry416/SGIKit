...
extension SGExcelView{
    ...
    @discardableResult
    @objc
    open func addRow(_ row: SGExcelRow) -> Self{
        if datas == nil {
    ...
    @discardableResult
    @objc
    open func insertRow(at index: Int, row: SGExcelRow) -> Self{
    ...
    @discardableResult
    @objc
    open func deleteRow(at index: Int) -> Self{
        assert(datas.count > 0, "Delete operation must be relyed on the datas count bigger than 0.")
    ...
    @discardableResult
    @objc
    open func updateRow(at index: Int, row: SGExcelRow) -> Self{
        datas.remove(at: index)
        datas.insert(row, at: index)
        collectionView.reloadData()
    ...
    @discardableResult
    @objc
    open func setOnExcelWillEditListener(_ listener: ((_ content: String,  _ row: Int, _ column: Int) -> Void)?) -> Self{
...
//        }
    ...
    @discardableResult
    @objc
    open func setOnExcelDidEditListener(_ listener: ((_ content: String,  _ row: Int, _ column: Int) -> Void)?) -> Self{
    ...
    @discardableResult
    @objc
    open func setOnExcelCellClickListener(_ listener: ((_ row: Int, _ column: Int) -> Void)?) -> Self{
