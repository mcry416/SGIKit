...
open class SGExcelTextFieldCell: UICollectionViewCell {
...
extension SGExcelTextFieldCell {
    ...
    @objc
    open func setCellElements(_ count: Int){
    ...
    @objc
    open func setCellTextField(at index: Int, textField: UITextField){
